...
```{r manipulacao_dados_exercicio_1, cache = TRUE ,echo = TRUE}
...
\vspace{0.6cm}
```{r disp_11, cache=TRUE,echo = TRUE,fig.align='center',fig.width=5.5,fig.height=3.4,warning=FALSE}
...
\vspace{0.5cm}
```{r disp_12, cache=TRUE,echo = TRUE,fig.width=5.5,fig.height=3.5,fig.align='center'}
...
##Os valores desta tabela estão erradados
\vspace{1cm}
\begin{center}
`r legenda_table3`
\end{center}

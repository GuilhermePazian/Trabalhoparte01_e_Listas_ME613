...
```{r graf_box_1,cache = TRUE,echo=FALSE, fig.height=3, fig.width=6,fig.align='center',warning=FALSE,message=FALSE}
#gráficos
# boxplot sexo x peso
...
\vspace{0.5cm}
```{r disp_12, cache=TRUE,echo = FALSE,fig.width=5.5,fig.height=3.5,fig.align='center',warning=FALSE,message=FALSE}
...
```{r,echo = FALSE,fig.width=7,fig.height=4,fig.align='center',eval=TRUE,warning=FALSE,message=FALSE}
...
```{r ajust_model1, echo=F,eval=FALSE,warning=FALSE,message=FALSE}
library(ggplot2)

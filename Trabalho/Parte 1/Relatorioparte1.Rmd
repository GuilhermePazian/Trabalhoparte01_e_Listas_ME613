...
```{r disp_11, cache=TRUE,echo = FALSE,fig.align='center',fig.width=5.5,fig.height=3.5,warning=FALSE}
...
\item Faraway, J. J. (2014). Linear Models with R, Second Edition, Chapman &

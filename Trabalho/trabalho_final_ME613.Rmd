...
Como modelo inicial, proporemos um modelo
...
Com: $i = 1,\dots, 199$ e $j=1,2$

Significado dos parâmetros:

$B_0{ij}$: Valor esperado de $Y_{ij}$(Peso do individuo i do sexo j) para quando o valor de $x_{ij}$() é igual ao valor dá média amostral.
